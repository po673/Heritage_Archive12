      ...
      <div className="about-hero-split scroll-reveal">
        <div className="about-split-text-side scroll-reveal-left">
          ...
          <p className="about-hero-desc">
            எங்கள் தளம் தமிழ் கலாச்சாரம், செம்மொழி இலக்கியம், வரலாறு, வரலாற்று மனிதர்கள், புகைப்படங்கள், அரிய ஆவணங்கள், ஒலி மற்றும் காணொளிகளை நவீன இணையத் தொழில்நுட்பத்தின் மூலம் ஒழுங்கமைத்து டிஜிட்டல் முறையில் பாதுகாத்து உலகிற்கு வழங்கும் ஒரு மதச்சார்பற்ற பண்பாட்டுக் காப்பகமாகும்.
          </p>
